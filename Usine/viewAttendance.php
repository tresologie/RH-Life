...
if (isset($_POST['view']) && !empty($_POST['dateTaken'])) {
    ...
    $filterMessage = "Liste d'appel du " . date('d/m/Y', strtotime($dateToShow));
}
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">
            Liste d'appel <b><?php echo $rrw['className'] ?? 'Non défini'; ?></b>
          </h1>
          <ol class="breadcrumb">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <!-- Message indiquant la période affichée -->
              <h6 class="m-0 font-weight-bold text-primary">
                <strong><?php echo $filterMessage; ?></strong></h6>
