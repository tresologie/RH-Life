              ...
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form class="user" method="Post" action="">
                    ...
                    <div class="form-group">
                        <input type="submit"  class="btn btn-primary btn-block" value="Login" name="Se connecter" />
                    </div>
                     </form>
...
?>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="font-weight-bold small" href="classTeacherLogin.php">Se connecter!</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
